...
// nDPI支持的协议汇总，每种协议在这里都会分配一个唯一的ID号
#define NDPI_PROTOCOL_UNKNOWN 	           0
...
#define NDPI_MAX_SUPPORTED_PROTOCOLS                    (NDPI_LAST_IMPLEMENTED_PROTOCOL + 1)            // 当前最大支持的协议数量
#define NDPI_MAX_NUM_CUSTOM_PROTOCOLS                   (NDPI_NUM_BITS-NDPI_LAST_IMPLEMENTED_PROTOCOL)  // 当前还可以自定义的协议数量
#endif
