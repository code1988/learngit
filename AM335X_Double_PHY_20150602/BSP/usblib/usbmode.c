...
//*****************************************************************************
void 
USBStackModeSet(unsigned int ulIndex, tUSBMode eUSBMode,
...
USB0DualModeIntHandler(void)
{
    ...
    if(ulStatus & USB_HOST_INTS)
    {
        ...
        //
        //wangyao_USBHostIntHandlerInternal(0, ulStatus & USB_HOST_INTS);
    ...
    switch(g_eUSBMode)
    {
        ...
        case USB_MODE_HOST:
        {
            ...
            // process.
            //
            //wangyao_USBHostIntHandlerInternal(0, ulStatus);
        ...
        case USB_MODE_DEVICE:
        {
            ...
            //
            //wangyao_USBDeviceIntHandlerInternal(0, ulStatus);
...
//*****************************************************************************
void
USBDualModeInit(unsigned int ulIndex)
{
    //
...
//*****************************************************************************
void
USBDualModeTerm(unsigned int ulIndex)
{
    //
    // We only support a single USB controller.
    //
...
//*****************************************************************************
void
USBOTGModeTerm(unsigned int ulIndex)
{
    //
    // We only support a single USB controller.
    //
...
//*****************************************************************************
void
USBOTGModeInit(unsigned int ulIndex, unsigned int ulPollingRate,
               void *pvPool, unsigned int ulPoolSize)
{
    //
    // We only support a single USB controller.
    //
...
USBOTGRemovePower(unsigned long ulIndex)
{
    ...
    if(USBHCDPowerAutomatic(ulIndex) == 0)
    {
        ...
        sEvent.ulInstance = 0;
        //wangyao_InternalUSBHCDSendEvent(0, &sEvent, USBHCD_EVFLAG_PWRDIS);
    }
}
...
//*****************************************************************************
void
USBOTGPollRate(unsigned int ulIndex, unsigned int ulPollRate)
{
    //
    // Save the timeout.
    //
       ...
       (USBHCDPowerAutomatic(0) == 0))
    {
        ...
        switch(ulMode)
        {
            ...
            case USB_OTG_MODE_ASIDE_AVAL:
            {
                ...
                sEvent.ulInstance = 0;
                //wangyao_InternalUSBHCDSendEvent(0, &sEvent, USBHCD_EVFLAG_PWREN);
...
//*****************************************************************************
void
USBOTGMain(unsigned int ulMsTicks)
{
    tEventInfo sEvent;
