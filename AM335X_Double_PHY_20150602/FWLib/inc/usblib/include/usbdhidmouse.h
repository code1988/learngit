...
//
//*****************************************************************************
extern void *USBDHIDMouseInit(unsigned int ulIndex,
                              const tUSBDHIDMouseDevice *psDevice);
extern void *USBDHIDMouseCompositeInit(unsigned int ulIndex,
                                       const tUSBDHIDMouseDevice *psDevice);
extern void USBDHIDMouseTerm(void *pvInstance);
extern void *USBDHIDMouseSetCBData(void *pvInstance, void *pvCBData);
extern unsigned int USBDHIDMouseStateChange(void *pvInstance, char cDeltaX,
                                             char cDeltaY,
